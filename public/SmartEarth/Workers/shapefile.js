...
(function (global, factory) {
  ...
  function open(shp$$1, dbf$$1, options) {
    if (typeof dbf$$1 === "string") {
      if (!/\.dbf$/.test(dbf$$1) && !dbf$$1.includes("blob:")) dbf$$1 += ".dbf";
    ...
    if (typeof shp$$1 === "string") {
      if (!/\.shp$/.test(shp$$1) && !shp$$1.includes("blob:")) shp$$1 += ".shp";
      if (dbf$$1 === undefined && !shp$$1.includes("blob:")) dbf$$1 = path(shp$$1.substring(0, shp$$1.length - 4) + ".dbf", options).catch(function () { });
